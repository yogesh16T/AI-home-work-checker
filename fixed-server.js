...
**Overall Assessment**: This is a comprehensive homework submission that demonstrates understanding of key concepts in ${data.subject}.
...
- Review current research in field
...
server.listen(PORT, () => {
  ...
  console.log('');
  console.log('⚠️  UPDATE FRONTEND .env to use port ' + PORT);
